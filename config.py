...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6059610280:AAEoR1vdoWvv3vLAdwMKX1Qk4b_RebslKZQ")
...
DB_NAME = os.environ.get("DATABASE_NAME", "leecher")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002133392581"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1370501629").split()):
        ADMINS.append(int(x))
except ValueError:
